...
data = dict(
    train=dict(dataset=dict(type=dataset_type, is_class_agnostic=True)),
    val=dict(type=dataset_type, is_class_agnostic=False),
    test=dict(type=dataset_type, is_class_agnostic=False),
)
