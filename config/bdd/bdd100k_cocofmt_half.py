...
custom_imports = dict(
    imports=["safednn_naptron.uncertainty.coco_ood_dataset"], allow_failed_imports=False
)

data = dict(
    train=dict(
        dataset=dict(type=dataset_type, classes=CLASSES, filter_unknown_imgs=True)
    ),
