...
class GaussianBBoxHead(Shared2FCBBoxHead):
    ...
    def __init__(self, *args, **kwargs):
        super(GaussianBBoxHead, self).__init__(*args, **kwargs)
    ...
    def forward(self, x):
        ...
        bbox_pred, sigma = (
            bbox_pred[..., : int(self.out_dim_reg / 2)],
            bbox_pred[..., int(self.out_dim_reg / 2) :],
        )
        ...
        if bbox_pred is not None:
            ...
            if pos_inds.any():
                ...
                if self.reg_class_agnostic:
                    ...
                    pos_bbox_sigma = sigma.view(sigma.size(0), 4)[
                        pos_inds.type(torch.bool)
                    ]
                else:
                    ...
                    pos_bbox_sigma = sigma.view(sigma.size(0), -1, 4)[
                        pos_inds.type(torch.bool), labels[pos_inds.type(torch.bool)]
                    ]
