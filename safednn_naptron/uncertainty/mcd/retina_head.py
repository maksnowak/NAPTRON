...
class MCDRetinaHead(RetinaHead):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(MCDRetinaHead, self).__init__(*args, **kwargs)
    ...
    def simple_test_bboxes(self, feats, img_metas, rescale=False):
        ...
        cls_scores, bbox_preds, label_uncertainty = self.mcd_uncertainty(
            cls_scores_mcd, bbox_preds_mcd
        )
    ...
    def mcd_uncertainty(self, cls_scores, bbox_preds):
        ...
        for i in range(len(cls_scores)):
            cs = cls_scores[i].mean(dim=0)  # [1, 180, H, W]
            mean_cls_score.append(cs)
            bp = bbox_preds[i].mean(dim=0)
            mean_bbox_pred.append(bp)
        ...
        return mean_cls_score, mean_bbox_pred, uncertainty
    ...
    def _get_bboxes_single(
        ...
        **kwargs
        ...
        for level_idx, (
            ...
            uncertainty = uncertainty.flatten()[keep_idxs]
